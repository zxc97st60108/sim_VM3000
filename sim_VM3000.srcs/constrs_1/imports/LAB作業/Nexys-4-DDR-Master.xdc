...
# set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { LED_clk }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { LED_pdm }]; #IO_L24P_T3_RS1_15 Sch=led[1]
# set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { LED_clk }]; #IO_L17N_T2_A25_15 Sch=led[2]
...
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { LED_clk }]; #IO_L14N_T2_SRCC_14 Sch=led[9]     clock capable
...
# set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { pdm_signal }]; #IO_L16N_T2_A27_15 Sch=ja[7]
# set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { PDMclk }]; #IO_L16P_T2_A28_15 Sch=ja[8]
...
# set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { PDMclk }]; #IO_L15P_T2_DQS_15 Sch=jb[4]
