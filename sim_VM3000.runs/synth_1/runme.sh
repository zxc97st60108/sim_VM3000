...
HD_PWD='D:/Vivado/sim_VM3000/sim_VM3000.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vm3000.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vm3000.tcl
