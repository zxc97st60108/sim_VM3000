...
HD_PWD='D:/Vivado/sim_VM3000/sim_VM3000.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vm3000.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vm3000.tcl -notrace
